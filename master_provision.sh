...
sudo apt install -y apache2 mysql-server php libapache2-mod-php curl unzip git composer sed openssl lynx php-mysql php-mbstring php-gd  php-xml  php-curl php-mysqli php-intl php-bz2 
